...
def validate_prompt_contract_invariants(
    contract: dict[str, Any],
    root: Path | None = None,
    contract_path: Path | None = None,
) -> None:
    resolved_root = (root or Path.cwd()).resolve()
    resolved_path = contract_path or (resolved_root / "review-prompt-contract.yaml")
    errors = validate_review_prompt_contract_invariants(resolved_root, resolved_path, contract, False)
    if errors:
...
def validate_review_packet(
    ...
    validate_prompt_contract_invariants(prompt_contract_data, root, prompt_contract_path)
