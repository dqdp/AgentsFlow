...
def render_review_prompt(packet: dict[str, Any], role_contract: dict[str, Any]) -> str:
    return (
        ...
        "risk_surface_profile, failure_path_matrix, changed_files, verification_gate_report, "
        "evidence_freshness, and known_blockers. Do not invent a separate focus map. "
        ...
        "verification_gap, or valid_late_discovery instead of presenting it as an ordinary "
