...
def invocation_metadata(reviewer: str) -> dict:
    ...
    return {
        ...
        "command": "claude -p agentsflow-review-prompt.md --output-format json --permission-mode default --tools Read --model opus --effort max --max-turns 10 --no-session-persistence",
